...
create [cview](https://github.com/malivvan/vv/pkg/cui). It also explains any
...
## cview is [thread-safe](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#hdr-Concurrency)

tview [is not thread-safe](https://godoc.org/github.com/rivo/tview#hdr-Concurrency).

## [Application.QueueUpdate](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#Application.QueueUpdate) and [Application.QueueUpdateDraw](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#Application.QueueUpdateDraw) do not block
...
Call [Box.SetBackgroundTransparent](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#Box.SetBackgroundTransparent)
to enable background transparency.

## Double clicks are not handled by default

All clicks are handled as single clicks until an interval is set with [Application.SetDoubleClickInterval](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#Application.SetDoubleClickInterval).

## Tables are sorted when a fixed row is clicked by default

Call [Table.SetSortClicked](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#Table.SetSortClicked)
...
This greatly improves buffer efficiency. [TextView.Write](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#TextView.Write)
is 90% faster and [TextView.Draw](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#TextView.Draw)
is 50% faster.
...
Because cview is [thread-safe](https://docs.rocket9labs.com/github.com/malivvan/vv/pkg/cui/#hdr-Concurrency),
