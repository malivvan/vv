...
func globalSymbol(name string, index int) *vvm.Symbol {
	return symbol(name, vvm.ScopeGlobal, index)
}

func localSymbol(name string, index int) *vvm.Symbol {
	return symbol(name, vvm.ScopeLocal, index)
}

func freeSymbol(name string, index int) *vvm.Symbol {
	return symbol(name, vvm.ScopeFree, index)
}

func symbolTable() *vvm.SymbolTable {
	return vvm.NewSymbolTable()
}

func resolveExpect(
	t *testing.T,
	symbolTable *vvm.SymbolTable,
	name string,
	expectedSymbol *vvm.Symbol,
	expectedDepth int,
) {
