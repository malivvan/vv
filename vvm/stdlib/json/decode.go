...
func Decode(data []byte) (vvm.Object, error) {
	var d decodeState
...
func (d *decodeState) value() (vvm.Object, error) {
	switch d.opcode {
	default:
		panic(phasePanicMsg)
	case scanBeginArray:
...
func (d *decodeState) array() (vvm.Object, error) {
	var arr []vvm.Object
	for {
	...
	return &vvm.Array{Value: arr}, nil
}

func (d *decodeState) object() (vvm.Object, error) {
	m := make(map[string]vvm.Object)
	for {
	...
	return &vvm.Map{Value: m}, nil
}

func (d *decodeState) literal() (vvm.Object, error) {
