...
func Opts() *testopts {
	return &testopts{
		...
		symbols:     make(map[string]vvm.Object),
		maxAllocs:   -1,
		skip2ndPass: false,
	}
}
...
func (o *testopts) Symbol(name string, value vvm.Object) *testopts {
	c := o.copy()
...
func TestUndefined(t *testing.T) {
	expectRun(t, `out = undefined`, nil, vvm.UndefinedValue)
	expectRun(t, `out = undefined.a`, nil, vvm.UndefinedValue)
	expectRun(t, `out = undefined[1]`, nil, vvm.UndefinedValue)
	expectRun(t, `out = undefined.a.b`, nil, vvm.UndefinedValue)
	expectRun(t, `out = undefined[1][2]`, nil, vvm.UndefinedValue)
...
func TestBuiltinFunction(t *testing.T) {
	...
	expectRun(t, `out = int([1])`, nil, vvm.UndefinedValue)
	expectRun(t, `out = int({a: 1})`, nil, vvm.UndefinedValue)
	expectRun(t, `out = int(undefined)`, nil, vvm.UndefinedValue)
	...
	expectRun(t, `out = int(undefined, undefined)`, nil, vvm.UndefinedValue)
	...
	expectRun(t, `out = string(undefined)`, nil, vvm.UndefinedValue) // not "undefined"
	...
	expectRun(t, `out = float(true)`, nil, vvm.UndefinedValue)
	expectRun(t, `out = float(false)`, nil, vvm.UndefinedValue)
	expectRun(t, `out = float('8')`, nil, vvm.UndefinedValue)
	expectRun(t, `out = float([1,8.1,true,3])`, nil, vvm.UndefinedValue)
	expectRun(t, `out = float({a: 1, b: "foo"})`, nil, vvm.UndefinedValue)
	expectRun(t, `out = float(undefined)`, nil, vvm.UndefinedValue)
	...
	expectRun(t, `out = float(undefined, undefined)`, nil, vvm.UndefinedValue)

	expectRun(t, `out = char(56)`, nil, '8')
	expectRun(t, `out = char(1.8)`, nil, vvm.UndefinedValue)
	expectRun(t, `out = char("-52.2")`, nil, vvm.UndefinedValue)
	expectRun(t, `out = char(true)`, nil, vvm.UndefinedValue)
	expectRun(t, `out = char(false)`, nil, vvm.UndefinedValue)
	expectRun(t, `out = char('8')`, nil, '8')
	expectRun(t, `out = char([1,8.1,true,3])`, nil, vvm.UndefinedValue)
	expectRun(t, `out = char({a: 1, b: "foo"})`, nil, vvm.UndefinedValue)
	expectRun(t, `out = char(undefined)`, nil, vvm.UndefinedValue)
	...
	expectRun(t, `out = char(undefined, undefined)`, nil, vvm.UndefinedValue)
	...
	expectRun(t, `out = bytes(1.8)`, nil, vvm.UndefinedValue)
	expectRun(t, `out = bytes("-522")`, nil, []byte{'-', '5', '2', '2'})
	expectRun(t, `out = bytes(true)`, nil, vvm.UndefinedValue)
	expectRun(t, `out = bytes(false)`, nil, vvm.UndefinedValue)
	expectRun(t, `out = bytes('8')`, nil, vvm.UndefinedValue)
	expectRun(t, `out = bytes([1])`, nil, vvm.UndefinedValue)
	expectRun(t, `out = bytes({a: 1})`, nil, vvm.UndefinedValue)
	expectRun(t, `out = bytes(undefined)`, nil, vvm.UndefinedValue)
	...
	expectRun(t, `out = bytes(undefined, undefined)`, nil, vvm.UndefinedValue)
	...
	vvm.MaxStringLen = 2147483647

	// delete
	expectError(t, `delete()`, nil, vvm.ErrWrongNumArguments.Error())
	expectError(t, `delete(1)`, nil, vvm.ErrWrongNumArguments.Error())
	expectError(t, `delete(1, 2, 3)`, nil, vvm.ErrWrongNumArguments.Error())
	expectError(t, `delete({}, "", 3)`, nil, vvm.ErrWrongNumArguments.Error())
	...
	expectRun(t, `out = delete({}, "")`, nil, vvm.UndefinedValue)
	...
	// splice
	expectError(t, `splice()`, nil, vvm.ErrWrongNumArguments.Error())
	...
	expectError(t, `splice([], 0, immutable({}))`, nil,
		`invalid type for argument 'third'`)
	expectError(t, `splice([], 1)`, nil, vvm.ErrIndexOutOfBounds.Error())
	expectError(t, `splice([1, 2, 3], 0, -1)`, nil,
		vvm.ErrIndexOutOfBounds.Error())
...
func TestBytesN(t *testing.T) {
	curMaxBytesLen := vvm.MaxBytesLen
	defer func() { vvm.MaxBytesLen = curMaxBytesLen }()
	vvm.MaxBytesLen = 10
...
func TestBytes(t *testing.T) {
	...
	expectRun(t, `out = bytes("abcde")[10]`, nil, vvm.UndefinedValue)
}
...
func TestVMErrorUnwrap(t *testing.T) {
	...
	userFunc := func(err error) *vvm.BuiltinFunction {
		return &vvm.BuiltinFunction{Name: "user_func", Value: func(ctx context.Context, args ...vvm.Object) (vvm.Object, error) {
			return nil, err
		}}
	}
		...
		return &vvm.BuiltinModule{
			Attrs: map[string]vvm.Object{
				"afunction": &vvm.BuiltinFunction{
					Name: "afunction",
					Value: func(ctx context.Context, a ...vvm.Object) (vvm.Object, error) {
						return nil, err
					},
				},
			},
...
func TestFunction(t *testing.T) {
	...
	expectRun(t, `f := func(...x) { return x; }; out = f();`,
		nil, &vvm.Array{Value: []vvm.Object{}})
...
func TestIf(t *testing.T) {
	...
	expectRun(t, `if (false) { out = 10 }`, nil, vvm.UndefinedValue)
	...
	expectRun(t, `if (1 > 2) { out = 10 }`, nil, vvm.UndefinedValue)
...
func (o *StringDict) IndexGet(index vvm.Object) (vvm.Object, error) {
	strIdx, ok := index.(*vvm.String)
	if !ok {
		return nil, vvm.ErrInvalidIndexType
	}

	for k, v := range o.Value {
		if strings.EqualFold(strIdx.Value, k) {
			return &vvm.String{Value: v}, nil
		}
	}
...
func (o *StringDict) IndexSet(index, value vvm.Object) error {
	strIdx, ok := index.(*vvm.String)
	if !ok {
		return vvm.ErrInvalidIndexType
	}

	strVal, ok := vvm.ToString(value)
	if !ok {
		return vvm.ErrInvalidIndexValueType
	}
...
func (o *StringCircle) IndexGet(index vvm.Object) (vvm.Object, error) {
	intIdx, ok := index.(*vvm.Int)
	if !ok {
		return nil, vvm.ErrInvalidIndexType
	}
	...
	return &vvm.String{Value: o.Value[r]}, nil
}

func (o *StringCircle) IndexSet(index, value vvm.Object) error {
	intIdx, ok := index.(*vvm.Int)
	if !ok {
		return vvm.ErrInvalidIndexType
	}
...
func (o *StringArray) BinaryOp(
	...
	return nil, vvm.ErrInvalidOperator
}
...
func (o *StringArray) Equals(x vvm.Object) bool {
...
func (o *StringArray) Copy() vvm.Object {
	return &StringArray{
...
func (o *StringArray) IndexGet(index vvm.Object) (vvm.Object, error) {
	intIdx, ok := index.(*vvm.Int)
	if ok {
		if intIdx.Value >= 0 && intIdx.Value < int64(len(o.Value)) {
			return &vvm.String{Value: o.Value[intIdx.Value]}, nil
		}

		return nil, vvm.ErrIndexOutOfBounds
	}
	...
	if ok {
		for vidx, str := range o.Value {
			if strIdx.Value == str {
				return &vvm.Int{Value: int64(vidx)}, nil
			}
		}
...
func (o *StringArray) IndexSet(index, value vvm.Object) error {
	strVal, ok := vvm.ToString(value)
	if !ok {
		return vvm.ErrInvalidIndexValueType
	}
	...
	if ok {
		...
		return vvm.ErrIndexOutOfBounds
	}
...
func (o *StringArray) Call(
	...
	for i, v := range o.Value {
		if v == s1 {
			return &vvm.Int{Value: int64(i)}, nil
		}
	}
...
func TestIndexable(t *testing.T) {
	...
	expectRun(t, `out = dict["x"]`,
		Opts().Symbol("dict", dict()).Skip2ndPass(), vvm.UndefinedValue)
	...
	expectRun(t, `out = arr["four"]`,
		Opts().Symbol("arr", strArr()).Skip2ndPass(), vvm.UndefinedValue)
...
func (i *StringArrayIterator) Key() vvm.Object {
	return &vvm.Int{Value: int64(i.idx - 1)}
}

func (i *StringArrayIterator) Value() vvm.Object {
	return &vvm.String{Value: i.strArr.Value[i.idx-1]}
}

func (o *StringArray) Iterate() vvm.Iterator {
...
out = {
	...
	expectRun(t, `out = {foo: 5}["bar"]`, nil, vvm.UndefinedValue)
	expectRun(t, `key := "foo"; out = {foo: 5}[key]`, nil, 5)
	expectRun(t, `out = {}["foo"]`, nil, vvm.UndefinedValue)
			...
			Attrs: map[string]vvm.Object{
				"abs": &vvm.BuiltinFunction{
					...
					Value: func(ctx context.Context, a ...vvm.Object) (vvm.Object, error) {
						...
						return &vvm.Float{Value: math.Abs(v)}, nil
					},
				},
			},
		})
...
`), "Runtime Error: not callable: int\n\tat mod1:3:4\n\tat test:4:1")
	...
	expectRun(t, `out = import("mod0")`,
		Opts().Module("mod0", ``), vvm.UndefinedValue)
	expectRun(t, `out = import("mod0")`,
		...
		&vvm.BuiltinModule{
			Attrs: map[string]vvm.Object{
				"intn": &vvm.BuiltinFunction{
					...
					Value: func(ctx context.Context, a ...vvm.Object) (vvm.Object, error) {
						v, _ := vvm.ToInt64(a[0])
						return &vvm.Int{Value: rand.Int63n(v)}, nil
					},
				},
			},
		})
...
func testAllocsLimit(t *testing.T, src string, limit int64) {
	expectRun(t, src,
		Opts().Skip2ndPass(), vvm.UndefinedValue) // no limit
	expectRun(t, src,
		Opts().MaxAllocs(limit).Skip2ndPass(), vvm.UndefinedValue)
	expectRun(t, src,
		Opts().MaxAllocs(limit+1).Skip2ndPass(), vvm.UndefinedValue)
	if limit > 1 {
		expectError(t, src,
...
b := a.x.c`, nil, vvm.UndefinedValue)
...
b := a.x.y`, nil, vvm.UndefinedValue)
...
func TestSourceModules(t *testing.T) {
	...
	testEnumModule(t, `out = enum.all(0, enum.value)`,
		vvm.UndefinedValue) // non-enumerable: undefined
	...
	testEnumModule(t, `out = enum.at(["one","two","three"], 3)`,
		vvm.UndefinedValue)
	testEnumModule(t, `out = enum.at(["one","two","three"], "1")`,
		vvm.UndefinedValue) // non-int index: undefined
	...
	testEnumModule(t, `out = enum.at({a:"one",b:"two",c:"three"}, "d")`,
		vvm.UndefinedValue)
	testEnumModule(t, `out = enum.at({a:"one",b:"two",c:"three"}, 'a')`,
		vvm.UndefinedValue) // non-string index: undefined
	...
	testEnumModule(t, `out = enum.filter([false,1,0,2], enum.value)`,
		ARR{1, 2})
	testEnumModule(t, `out = enum.filter({}, enum.value)`,
		vvm.UndefinedValue) // non-array: undefined
...
func expectRun(
	...
	if !opts.skip2ndPass {
		...
		case *vvm.Array:
			expectedObj = &vvm.ImmutableArray{Value: eo.Value}
		case *vvm.Map:
			expectedObj = &vvm.ImmutableMap{Value: eo.Value}
		}
...
func traceCompileRun(file *parser.File, symbols map[string]vvm.Object, modules *vvm.ModuleMap, maxAllocs int64) (res map[string]vvm.Object, trace []string, err error) {
	...
	tr := &vmTracer{}
	c := vvm.NewCompiler(file.InputFile, symTable, nil, modules, tr)
	err = c.Compile(file)
	trace = append(trace,
		fmt.Sprintf("\n[Compiler Trace]\n\n%s",
			strings.Join(tr.Out, "")))
	...
	err = v.Run()
	{
		res = make(map[string]vvm.Object)
...
func formatGlobals(globals []vvm.Object) (formatted []string) {
...
func errorObject(v interface{}) *vvm.Error {
	return &vvm.Error{Value: toObject(v)}
}

func toObject(v interface{}) vvm.Object {
	switch v := v.(type) {
	case vvm.Object:
		return v
	case string:
	...
	case rune:
		return &vvm.Char{Value: v}
	case byte: // for convenience
		return &vvm.Char{Value: rune(v)}
	case float64:
		return &vvm.Float{Value: v}
	case []byte:
		return &vvm.Bytes{Value: v}
	case MAP:
		objs := make(map[string]vvm.Object)
		for k, v := range v {
			objs[k] = toObject(v)
		}

		return &vvm.Map{Value: objs}
	case ARR:
		var objs []vvm.Object
		for _, e := range v {
	...
	case IMAP:
		...
		return &vvm.ImmutableMap{Value: objs}
	case IARR:
		var objs []vvm.Object
		for _, e := range v {
			objs = append(objs, toObject(e))
		...
		return &vvm.ImmutableArray{Value: objs}
	}

	panic(fmt.Errorf("unknown type: %T", v))
}

func objectZeroCopy(o vvm.Object) vvm.Object {
	switch o.(type) {
	case *vvm.Int:
		return &vvm.Int{}
	case *vvm.Float:
	...
	case *vvm.Map:
		return &vvm.Map{}
	case *vvm.Undefined:
		return vvm.UndefinedValue
	case *vvm.Error:
		return &vvm.Error{}
	case *vvm.Bytes:
		return &vvm.Bytes{}
	case *vvm.ImmutableArray:
		return &vvm.ImmutableArray{}
